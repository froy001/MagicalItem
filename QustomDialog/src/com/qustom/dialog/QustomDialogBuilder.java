...
public class QustomDialogBuilder extends AlertDialog.Builder{
    ...
    // add a view to the AlertDialog
    public QustomDialogBuilder addViewToLinearLayout(View v, int layoutResId){
    	LinearLayout linearLayout=(LinearLayout)mDialogView.findViewById(layoutResId);
