/**
 * This is an upgrade to the Daniel Smith code https://github.com/danoz73/QustomDialog
 * 
 * Author: David Fradis 
 */
...
public class FroyQustomDialogBuilder extends AlertDialog.Builder{
    ...
    public FroyQustomDialogBuilder(Context context) {
        super(context);
     ...
     * 
     * @param colorInt for passing "R.color.*" values
     */
    public FroyQustomDialogBuilder setDividerColor(int colorInt) {
    	mDivider.setBackgroundColor(colorInt);
    	return this;
    }

    @Override
    public FroyQustomDialogBuilder setTitle(CharSequence text) {
        mTitle.setText(text);
        return this;
    }

    public FroyQustomDialogBuilder setTitleColor(int colorInt) {
    	mTitle.setTextColor(colorInt);
    	return this;
    }

    @Override
    public FroyQustomDialogBuilder setMessage(int textResId) {
        mMessage.setText(textResId);
        return this;
    }

    @Override
    public FroyQustomDialogBuilder setMessage(CharSequence text) {
        mMessage.setText(text);
        return this;
    }

    @Override
    public FroyQustomDialogBuilder setIcon(int drawableResId) {
        mIcon.setImageResource(drawableResId);
        return this;
    }

    @Override
    public FroyQustomDialogBuilder setIcon(Drawable icon) {
     ...
     * @param context
     */
    public FroyQustomDialogBuilder setCustomView(int resId, Context context) {
